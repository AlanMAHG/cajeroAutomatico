        ...
        <div class="monitorUsario">
            ...
            <section class="accionesCuenta">
                <form id="formulario">
                    ...
                    <button class="btn btn-primary botonRetirar" onclick="retirando()">Retirar</button>
                    <input class="retirarDepositar" type="text">
                    <button class="btn btn-primary botonAbonar" onclick="depositando()">Depositar</button>
                </form>
            </section>
        </div>`;
        /* mostrarDatosUsuario(); */
